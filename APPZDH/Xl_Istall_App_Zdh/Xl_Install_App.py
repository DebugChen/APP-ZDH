...
class MyTestCase_Xl_Intall_Login(unittest.TestCase):
    ...
    def test_Xl_Intall_Login(self):
        ...
        desired_caps["deviceName"] = '1ec63518'
        ...
        try:
            dr.find_element_by_id("org.xc.starlinkother:id/")
        ...
        # # 输入IMEI号808030501410519,861097040098216
        # dr.find_element_by_id('org.xc.starlinkother:id/etImei').send_keys('808030501410519')
        # # 输入姓名
        ...
        # time.sleep(1)
        # # if SXZT1==dr.find_element_by_id('org.xc.starlinkother:id/btnOnline').click():
        # #     print("设备未上线")
        # # else:
        # # 点击提交
        ...
        # time.sleep(3)
        #
        # # 根据 安装界面---861097040098216元素是否存在---判断是否安装成功
        # try:
        #     dr.find_element_by_xpath('//*[@text="808030501410519"]')
        # except:
        #     print("安装成功，没有找到808030501410519元素")
        # else:  # 找到的内容
        #     print("安装失败，找到808030501410519元素")

        # 根据上线状态,判断是否执行下一步操作
        # try:
        #     dr.find_element_by_xpath('//*[@text="上线状态：已上线"]').click()
        # except:
        #     print("设备未上线")
        # else:
